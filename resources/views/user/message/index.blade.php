                    ...
                    <div class="chat">
                        <div class="chat-header clearfix">
                            {{-- <div class="row">
                                ...
                                <div class="col-lg-6 hidden-sm text-right">
                                    <a href="javascript:void(0);" class="btn btn-outline-dark"><i
                        ...
                        <div class="chat-history">
                            <ul class="m-b-0" id="d_chat_history">
                                <img class="img-fluid d-block mx-auto" src="{{ asset('img/nodata.svg') }}" width="500"
                                    alt="nodata">
                            </ul>
                        </div>
                            ...
                            <form id="message_form" enctype="multipart/form-data">
                                <div class="input-group mb-0">
                                    ...
                                    <div class="input-group-append" role="button">
                                        <span class="input-group-text"><i class="fas fa-paper-plane"></i>
                                        </span>
                                    </div>
                                </div>
                            </form>
