...
Good Day! Your <span style="font-weight: bold; color: #e6c348">Boost Post</span> request has been approved.<br>
...
Unfortunately your <span style="font-weight: bold; color: #e6c348">Boost Post</span> request has been rejected.<br>
@component('mail::panel')
Requested Post ⚡ <br>
Transaction No: {{ $payment->transaction_no }} <br>
Title: {{ $payment->paymentable->post->title }} <br>
