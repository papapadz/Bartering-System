...
@section('title', 'Admin | Flash Barter')
                ...
                <div class="card">
                    <div class="card-header border-0 bg-warning">
                        <h2 class="text-white text-center font-weight-normal">
                            <a class="text-white float-left" href="{{ route('admin.flash_barters.index') }}"><i
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                @if ($payment->status !== \App\Models\Payment::REJECTED)
                                    ...
                                    <form action="{{ route('admin.flash_barters.update', $payment) }}" method="post"
                                        id="payment_form">
                                        @csrf @method('PUT')
