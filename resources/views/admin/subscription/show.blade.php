...
@section('title', 'Admin | Subscription Info')
                ...
                <div class="card">
                    <div class="card-header border-0 bg-warning">
                        <h2 class="text-white text-center font-weight-normal">
                            <a class="text-white float-left" href="{{ route('admin.subscriptions.index') }}"><i
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="row py-3">
                                    <div class="col-md-6 font-weight-normal">
                                        ...
                                        <h4>Subscribed At: <span
                                                class="font-weight-normal">{{ formatDate($payment->created_at) }}
                                                <i class="far fa-calendar ms-1"></i></span>
                                        </h4>
                                        <h4>Subscription Due: <span
                                                class="font-weight-normal">{{ formatDate(\App\Models\Subscription::find($payment->paymentable_id)->due) }}
                                                <i class="far fa-calendar ms-1"></i></span>
                                        </h4>
                                        {{-- Status --}}
                                        ...
                                        <div class="collapse" id="show_payment_receipt">
                                            ...
                                            <div class="d-block d-md-none">
                                                <h4 class="font-weight-normal mt-2">Amount Paid : <span class=" fw-bold">₱
                                ...
                                @if ($payment->status !== \App\Models\Payment::REJECTED)
                                    ...
                                    <form action="{{ route('admin.subscriptions.update', $payment) }}" method="post"
                                        id="payment_form">
                                        @csrf @method('PUT')
